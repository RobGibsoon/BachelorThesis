...
inputs = inputs = {
    1: ("PTC_MR", "ann", True, False),
    2: ("PTC_MR", "knn", True, False),
    3: ("PTC_MR", "svm", True, False),
    4: ("Mutagenicity", "ann", True, False),
    5: ("Mutagenicity", "knn", True, False),
    6: ("Mutagenicity", "svm", True, False),
    7: ("MUTAG", "ann", True, False),
    8: ("MUTAG", "knn", True, False),
    9: ("MUTAG", "svm", True, False),
    10: ("PTC_MR", "ann", False, False),
    11: ("PTC_MR", "knn", False, False),
    12: ("PTC_MR", "svm", False, False),
    13: ("Mutagenicity", "ann", False, False),
    14: ("Mutagenicity", "knn", False, False),
    15: ("Mutagenicity", "svm", False, False),
    16: ("MUTAG", "ann", False, False),
    17: ("MUTAG", "knn", False, False),
    18: ("MUTAG", "svm", False, False),
    19: ("PTC_MR", "ann", True, True),
    20: ("PTC_MR", "knn", True, True),
    21: ("PTC_MR", "svm", True, True),
    22: ("Mutagenicity", "ann", True, True),
    23: ("Mutagenicity", "knn", True, True),
    24: ("Mutagenicity", "svm", True, True),
    25: ("MUTAG", "ann", True, True),
    26: ("MUTAG", "knn", True, True),
    27: ("MUTAG", "svm", True, True),
    28: ("PTC_MR", "ann", False, True),
    29: ("PTC_MR", "knn", False, True),
    30: ("PTC_MR", "svm", False, True),
    31: ("Mutagenicity", "ann", False, True),
    32: ("Mutagenicity", "knn", False, True),
    33: ("Mutagenicity", "svm", False, True),
    34: ("MUTAG", "ann", False, True),
    35: ("MUTAG", "knn", False, True),
    36: ("MUTAG", "svm", False, True),
}
