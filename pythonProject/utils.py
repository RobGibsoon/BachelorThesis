...
inputs = {
    ...
    21: ("Mutagenicity", "ann", True, True),
    22: ("Mutagenicity", "knn", True, True),
    23: ("Mutagenicity", "svm", True, True),
    24: ("MUTAG", "ann", True, True),
    25: ("MUTAG", "knn", True, True),
    26: ("MUTAG", "svm", True, True),
    27: ("PTC_MR", "ann", False, True),
    28: ("PTC_MR", "knn", False, True),
    29: ("PTC_MR", "svm", False, True),
    30: ("Mutagenicity", "ann", False, True),
    31: ("Mutagenicity", "knn", False, True),
    32: ("Mutagenicity", "svm", False, True),
    33: ("MUTAG", "ann", False, True),
    34: ("MUTAG", "knn", False, True),
    35: ("MUTAG", "svm", False, True),
}
